...
int main() {
    ...
    long len;
    double sum;
    //call assembly function with args type -> int
    printf("Compute area and circumference of a rectangle\n");
    printf("Enter the length of one size: \n");
    scanf("%d", &side1);
    printf("Enter the length of other size: \n");
    scanf("%d", &side2);
    ...
    //call assembly fubction with args type -> double(float)
    printf("Copute area and circumference of a circle\n");
    ...
    printf("The circumferene of the circle = %lf\n", c_circum);

    //call assembly function with args type -> string (char *)
    ...
    //call assembly function with args type -> array
