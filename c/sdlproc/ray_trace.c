...
void generays_rays(struct Circle circle, struct Ray rays[RAYS_NUMBER]) {
    for(int i = 0; i < RAYS_NUMBER; i++) {
        double angle = (double) 360 / 100 * i;
...
int main() {
    ...
    struct Circle shadow_circle = {.x = 650, .y = 300, .radius = 140};
