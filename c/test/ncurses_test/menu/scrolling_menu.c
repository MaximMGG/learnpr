...
i32 main() {
  ...
  attron(COLOR_PAIR(2));
  mvprintw(LINES - 2, 0, "Use PageUp adn PAgeDown to scroll or fown or up a page of items");
  mvprintw(LINES - 1, 0, "Arrow Kyes to naviage (F1 to exit)");
