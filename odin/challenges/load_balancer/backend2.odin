...
main :: proc() {
  endpoint := net.Endpoint{address = net.IP4_Address{127, 0, 0, 1}, port = 4445}
  ...
  index_file, index_file_err := os.open("./http/backend2.html", os.O_RDONLY)
  index_buf: [1024]byte
  if index_file_err != nil {
    fmt.eprintln("Can't open backend2.html", index_file_err)
    os.exit(1)
  }
