...
main :: proc() {
  endpoint := net.Endpoint{address = net.IP4_Address{127, 0, 0, 1}, port = 4446}
  ...
  index_file, index_file_err := os.open("./http/backend3.html", os.O_RDONLY)
  index_buf: [1024]byte
  if index_file_err != nil {
    fmt.eprintln("Can't open backend3.html", index_file_err)
    os.exit(1)
  }
